...
(function () {
  ...
  const HELP_HTML = `<div class="fm-card fm-help-text">
    ...
    <ul>
      ...
      <li><b>פעם בחודשיים:</b> בסוף התקופה מורידים מאתר לאומי (במחשב) פירוטי כרטיסים ועו"ש. שמים אותם בתיקייה שנפתחת בכפתור "📥 תיקיית הפירוטים מלאומי" במסך במחשב (ליד "רענן"), או משאירים ב"הורדות". ואז "רענן" ו"בנה". שולחים עד ה-15.</li>
    </ul>
