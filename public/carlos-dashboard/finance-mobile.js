...
(function () {
  ...
  const HELP_HTML = `<div class="fm-card fm-help-text">
    ...
    <ul>
      ...
      <li><b>פעם בחודשיים:</b> בסוף התקופה מורידים מאתר לאומי (במחשב) פירוטי כרטיסים ועו"ש. הם נשמרים לבד ב"הורדות", או שמים אותם בתיקייה "פירוטים מלאומי" בשולחן העבודה. ואז "רענן" ו"בנה". שולחים עד ה-15.</li>
    </ul>
